...
*/
function mergeRecords(records, dedupeConfig) {
    var _a;
    ...
    for (const record of records) {
        ...
        if (Array.isArray(dedupeConfig.on)) {
            ...
            const keyParts = dedupeConfig.on.map(field => { var _a, _b; return ((_b = (_a = record[field]) === null || _a === void 0 ? void 0 : _a.value) === null || _b === void 0 ? void 0 : _b.toString()) || ""; });
        ...
        if (dedupeConfig.type === 'delete') {
            ...
            for (let i = 0; i < group.length; i++) {
                ...
                for (const [key, value] of Object.entries(record)) {
                    if (!((_a = mergedRecord[key]) === null || _a === void 0 ? void 0 : _a.value) && value.value !== undefined) {
...
//# sourceMappingURL=merge_processor.js.map