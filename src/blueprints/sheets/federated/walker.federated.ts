...
/**
 * Walker Payroll Federated Sheet
 * 
 * This sheet federates walker payroll data including standard benefit contributions.
 * Maps fields from the all-data sheet for BTK, ERM, LO1, and RTH contribution types
 * used in walker-specific payroll processing.
 */
export const walkerFederatedSheet: FederatedSheetConfig = {
  name: "Walker Payroll",
  slug: "walker-payroll-federated",

  // Only include records that have at least one of the standard contribution amounts
  any_fields_required: ["btk1", "btk2", "erm3", "erm6", "lo1LoanPayment", "rth5", "rth6"],
