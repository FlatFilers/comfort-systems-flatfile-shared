...
/**
 * Extras Payroll Federated Sheet
 * 
 * This sheet federates extras payroll data including standard benefit contributions.
 * Maps fields from the all-data sheet for BTK, ERM, LO1, and RTH contribution types
 * used in extras payroll processing.
 */
export const extrasFederatedSheet: FederatedSheetConfig = {
  name: "Extras Payroll",
  slug: "extras-payroll-federated",
